...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <?php if (Auth::isStudent()): ?>
        ...
        <a href="<?= url('review/search') ?>" class="<?= $currentUri === 'review/search' ? 'active' : '' ?>"><span class="material-icons">search</span> Search</a>
        ...
        <a href="<?= url('review/myNotes') ?>" class="<?= $currentUri === 'review/myNotes' ? 'active' : '' ?>"><span class="material-icons">sticky_note_2</span> My Notes</a>
        <a href="<?= url('review/myBookmarks') ?>" class="<?= $currentUri === 'review/myBookmarks' ? 'active' : '' ?>"><span class="material-icons">bookmark</span> Bookmarks</a>
      <?php endif; ?>
      ...
      <?php if (Auth::isAdmin()): ?>
        ...
        <a href="<?= url('admin/backups') ?>" class="<?= strpos($currentUri, 'admin/backups') === 0 ? 'active' : '' ?>"><span class="material-icons">backup</span> Backups</a>
        <a href="<?= url('analytics') ?>" class="<?= strpos($currentUri, 'analytics') === 0 ? 'active' : '' ?>"><span class="material-icons">analytics</span> Analytics</a>
      ...
      <?php if (Auth::check()): ?>
        ...
        <a href="<?= url('auth/setup2fa') ?>" class="<?= $currentUri === 'auth/setup2fa' ? 'active' : '' ?>"><span class="material-icons">verified_user</span> Two-factor (2FA)</a>
  ...
  <div class="main-area">
    <header class="topbar">
      ...
      <form class="topbar-search" action="<?= url('review/search') ?>" method="get">
        <input type="hidden" name="r" value="review/search">
        <span class="material-icons">search</span>
        <input type="text" name="q" placeholder="Search courses, lessons, forums..." value="<?= e($_GET['q'] ?? '') ?>">
      </form>
